...
SRC=source/daten.cpp source/network.cpp source/boostMaxFlow.cpp source/CumulativeModel.cpp source/util.cpp source/MaxClosure_PP.cpp $(wildcard source/MaxClosure_B*.cpp) source/MaxClosureFactory.cpp source/UpitSolver.cpp source/graph.cpp source/SinglePSolver.cpp source/Preprocess.cpp source/SinglePModel.cpp source/SolutionMerger.cpp source/MergeSolver.cpp source/MergeSolverSimple.cpp source/MergeSolverCompact.cpp source/RandomSearch.cpp source/LocalSearch.cpp source/ConeMiner.cpp source/GRASPSolver.cpp $(LAPSO_SRC) #$(LR)/solver.cpp $(LR)/mip.cpp $(LR)/ACO_solution.cpp $(LR)/Timer.cc $(LR)/Random.cc $(LR)/MaxClosure_NetworkFlow_LR.cpp $(LR)/pheromones.cpp source/lr_graph.cpp $(LR)/solver_functions.cpp source/solver_interface.cpp source/MaxClosure_NetworkFlow.cpp $(LAPSO_SRC)
