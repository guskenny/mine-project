...
// // not working version
// void SolutionMerger::fullMerge(const std::vector<Sol_Int>&sols,
//   const std::vector<int> &include, std::vector<int> &fixed, std::vector<std::vector<int> > &set_groups, std::vector<int> &group_map){
...
//     // for (int i = 0; i < groups.size(); ++i){
//     //     SetObj temp_set_group(nB*nT);
//     //     temp_set_group.addElements(groups[i]);
//     //     set_groups.push_back(temp_set_group);
//     // }
...
// // SetObj version
// void SolutionMerger::fullMerge(const std::vector<Sol_Int>&sols,
//   const std::vector<int> &include, std::vector<int> &fixed, std::vector<SetObj> &groups, std::vector<int> &group_map){
...
//     groups.clear();
//     group_map.clear();
//     group_map = std::vector<int>(num_vars,0);

//     // establish vector for storing groups
//     SetObj zero_group(num_vars);

//     for(int j = 0; j < num_vars; ++j){
//       zero_group.addElement(j);
//       group_map[j] = 0;
//     }

//     // zero_group.fill();

//     groups.push_back(zero_group);
...
//             group_map[groups[group][i]] = groups.size();
//             // push current variable index to new group
//             temp_group.addElement(groups[group][i]);
//             // remove current variable from current group
//             // by overwriting variable with last variable in group
//             groups[group].removeElement(groups[group][i]);
//             // remove copy of last variable in group
//             // groups[group].pop_back();
//             i--; // decrement i to test newly inserted variable
//           }
